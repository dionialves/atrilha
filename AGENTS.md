...
Java 21 + Spring Boot 3, Maven, Spring Security (OAuth Google + email/senha BCrypt), PostgreSQL 16, Flyway, Spring Data JPA, Spring Mail. View: Thymeleaf + HTMX + Tailwind + Alpine.js + Lottie + PWA. **Não introduzir** React/Next, Redis, RabbitMQ, microservices ou CDNs pagos — rejeitados em PRD §9.4.
