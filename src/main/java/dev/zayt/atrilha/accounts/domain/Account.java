 ...
 * Credencial: {@code passwordHash} (BCrypt) obrigatório para contas ativas —
 * o CHECK {@code accounts_credential_chk} aceita {@code password_hash NULL}
 * apenas se {@code deleted_at} estiver preenchido (soft-delete histórico).</p>
 *
