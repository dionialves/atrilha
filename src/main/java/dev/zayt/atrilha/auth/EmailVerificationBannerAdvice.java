 ...
 */
@ControllerAdvice
class EmailVerificationBannerAdvice {

    private final AccountReader accountReader;

    EmailVerificationBannerAdvice(AccountReader accountReader) {
    ...
    boolean showEmailVerificationBanner(HttpServletRequest request) {
        if (!unverifiedEmail()) {
            return false;
        }
